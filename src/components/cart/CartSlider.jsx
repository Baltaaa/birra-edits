...
export default function CartSlider() {
    ...
    // cartContext
    const { cartList, clearCart, clearItem, totalCart, totalItem } = useCartContext()
                                        ...
                                        <div className="shadow-2xl rounded-t-xl shadow-black pb-6 px-4 sm:px-0">
                                            ...
                                            <div className="mt-6 mx-2">
                                                <NavLink
                                                    ...
                                                    <p className='opacity-100 flex'>Next<span className='px-2'><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
