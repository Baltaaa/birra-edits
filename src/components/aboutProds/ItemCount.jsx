    ...
    <>
      {check ?
        ...
        <div className='flex flex-row justify-center h-5/5 '>
          <button disabled={count===0} onClick={() => clickMenos()} className='hover:bg-slate-100 rounded-l-md font-extrabold border-t border-l border-b border-orange-200  hover:opacity-60  transition duration-300 ease-linear bg-current w-10 text-xl flex justify-center items-end py-1'><span className='w-full h-full grid place-content-center opacity-50 hover:opacity-90'><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="orange" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M20 12H4" />
          </svg></span></button>
          <div className='border-y  border-orange-200 border-lg bg-black w-36 flex flex-col flex-grow justify-center h-max content-evenly'>
            <button disabled={count===0} onClick={() => addToCart()} className='bg-black font-sans tracking-widest text-white w-max h-max py-1 self-center m-1 flex hover:text-orange-300 transition ease-in-out duration-300 flex-col gap-2'>ADD TO CART <p className='text-gray-50 text-xs mx-auto'><b className='text-orange-300'>{updateCount}</b></p></button>
          </div>
          <button disabled={count===0} onClick={() => clickMas()} className='hover:bg-slate-100 rounded-r-md font-extrabold border-t border-r border-b border-lg border-orange-200  hover:opacity-60  transition duration-300 ease-linear bg-current w-10 text-xl flex justify-center items-end py-1'><span className='w-full h-full grid place-content-center opacity-50 hover:opacity-90'><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="orange" strokeWidth={2}>
